...
public class FaceMergeServiceImpl implements FaceMergeService {
    ...
    @Override
    public JSONUtil faceMerge(String target, String template, String name) throws IOException, JSONException {
        ...
        pictureDao.insert(new Picture(name, LocalDateTime.now(), "人脸融合", mergeImage));
